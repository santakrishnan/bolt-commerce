...
import { Button, Card, Heading } from "@tfs-ucmp/ui";
    ...
    <div className="flex w-full justify-center pb-0 lg:pb-0">
      <div className="flex w-full max-w-[1440px] flex-col items-start">
        <div className="space-y-1 md:space-y-2">
          <Heading
            className="w-full max-w-[715px] text-[length:var(--font-size-2xl)] text-white uppercase leading-[1.2] tracking-[-0.449px] md:text-[length:var(--font-size-2xl)] md:leading-[44px] lg:text-[length:var(--font-size-2xl)] xl:text-[length:var(--font-size-4xl)]"
            level={1}
            weight="bold"
          >
